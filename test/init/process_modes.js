...
describe( "Process modes" + currentFileMark, function(){
  ...
  describe( "Process mode - \"single\"", function(){
    ...
    it("In process_mode \"single\" all libs from structure configs should be properly merged", function(next){
      infrastructure.init = original_initializer;
      infrastructure({ rootDir: path.join(__dirname, "fixtures/single_mode_config_libs") }, function(err, env){
        assert.deepEqual(env.classes, { 
          ClassA: {},
          ClassB: {},
          ClassSet: { 
            subA: {}, subAA: {}, subAAA: {},
        ...
        assert.deepEqual(env.config, { 
          mode:            "development",
          process_mode:    "single",
          rootDir:         path.join(__dirname, "fixtures/single_mode_config_libs"),
          config_prop_a: "config_val_a",
          config_prop_b: "config_val_b",
          structures: {
            "structure_a":{
              ...
              "engines": ["./engine_a.js"],
              "libs": {
                "ClassA": "./lib/ClassA.js",
                "ClassSet": ["lib/setA", "**/*.js", true]
              }
            },
            ...
            "structure_b":{
              ...
              "engines": ["./engine_b.js"],
              "libs": {
                "ClassB": "./lib/ClassB.js",
                "ClassSet": ["lib/setB", "**/*.js", true]
              }
            }
          }
        });
