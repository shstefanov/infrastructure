...
//       OR (p.products_id=3220)
    ...
    switch(args.length){
      ...
      case 1: 
        if(typeof args[0] === "string" && args[0].indexOf(".") !== -1){
          ...
          return [{}, {}, function(err, result){
            self.env.i.do(address, err, result);}];
        }
      ...
      case 2:
        if(typeof args[0] === "function") return false;
          ...
          var address = args[1];
          return [args[0] || {}, {}, function(err, result){self.env.i.do(address, err, result);}];
        }
      ...
      case 3:
        if(typeof args[0] === "function" || typeof args[1] === "function") return false;
          ...
          var address = args[2];
          return [args[0]||{}, args[1]||{}, function(err, result){self.env.i.do(address, err, result);}];
        }
  ...
  setupTable: function(instance, env, cb){
    ...
    instance.query = function(query, data, options, cb){
      ...
      return this.mysql.query(query, {values: data, options: options, context: instance}, cb);
    }
    cb();
  },
