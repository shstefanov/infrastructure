...
module.exports = DataLayer.extend("MongoLayer", {
  ...
  parseData: function(data, options){
    ...
    // if(!options.where && typeof data !== "undefined"){
    //   options.where = {};
    //   options.where[this.primaryKey] = data;
    // }
  ...
  find:    function(pattern, options, cb){
    ...
    this.query("SELECT @fields FROM @tableName @where @order @limit @order;", data, function(err, models){
